  ...
  return (
    <section
      ...
      style={{
        ...
        background: '#faf9f5',
        overflow: 'hidden',
        padding: 'clamp(50px, 5vw, 80px) clamp(20px, 3.5vw, 60px) clamp(60px, 6vw, 90px)',
    ...
    >
      {/* ═════════════════════════════════════════════════════════════════════
          SVG BACKGROUND LAYER: EXACT CONNECTING ORBITAL NETWORK & NODES
          ═════════════════════════════════════════════════════════════════════ */}
      <svg
        style={{
          position: 'absolute',
      ...
      >
        ...
        <path
          d="M 50 380 C 60 230, 180 270, 340 320 C 620 400, 880 260, 1120 140 C 1340 40, 1540 90, 1470 300 C 1410 470, 1260 540, 1020 560"
          stroke="#cbd5e1"
          strokeWidth="1.15"
          strokeDasharray="4 6"
          strokeLinecap="round"
        ...
        <path
          d="M 1080 130 C 1220 70, 1420 100, 1460 240 C 1480 360, 1380 440, 1260 480"
          stroke="#e2e8f0"
          strokeWidth="1"
          strokeDasharray="3 5"
          strokeLinecap="round"
        ...
        {/* Energy Nodes matching Reference 2 */}
        <circle cx="115" cy="300" r="3.2" fill="#84cc16" opacity="0.9" />
        <circle cx="125" cy="370" r="3" fill="#84cc16" opacity="0.85" />
        <circle cx="770" cy="270" r="3.2" fill="#84cc16" opacity="0.9" />
        <circle cx="970" cy="190" r="3" fill="#84cc16" opacity="0.85" />
        <circle cx="1120" cy="130" r="3.2" fill="#94a3b8" opacity="0.85" />
        <circle cx="1390" cy="250" r="3.5" fill="#84cc16" opacity="0.9" />
        <circle cx="1310" cy="460" r="3" fill="#84cc16" opacity="0.85" />

        {/* Delicate Sparkles */}
        <g transform="translate(125, 440)">
          <path d="M0 -6 Q0 0 6 0 Q0 0 0 6 Q0 0 -6 0 Q0 0 0 -6" fill="#84cc16" opacity="0.85" />
        </g>
        <g transform="translate(780, 285)">
          <path d="M0 -6 Q0 0 6 0 Q0 0 0 6 Q0 0 -6 0 Q0 0 0 -6" fill="#84cc16" opacity="0.85" />
        </g>
        <g transform="translate(1025, 225)">
          <path d="M0 -6 Q0 0 6 0 Q0 0 0 6 Q0 0 -6 0 Q0 0 0 -6" fill="#84cc16" opacity="0.85" />
        </g>
        <g transform="translate(1485, 205)">
          <path d="M0 -5.5 Q0 0 5.5 0 Q0 0 0 5.5 Q0 0 -5.5 0 Q0 0 0 -5.5" fill="#94a3b8" opacity="0.8" />
        </g>
        <g transform="translate(1205, 690)">
          <path d="M0 -5.5 Q0 0 5.5 0 Q0 0 0 5.5 Q0 0 -5.5 0 Q0 0 0 -5.5" fill="#84cc16" opacity="0.85" />
        </g>

        {/* Micro-Doodles */}
        <text x="1460" y="490" fill="#94a3b8" fontSize="13" fontFamily="monospace">✦</text>
        <text x="75" y="660" fill="#94a3b8" fontSize="13" fontFamily="monospace">+</text>
      </svg>

      {/* ═════════════════════════════════════════════════════════════════════
          MAIN CANVAS CONTAINER (TIGHT, HARMONIOUS, ZERO UNWANTED EMPTY GAPS)
          ═════════════════════════════════════════════════════════════════════ */}
      <div
        style={{
          width: '100%',
      ...
      >
        ...
        <div style={{ maxWidth: 460, position: 'relative', zIndex: 5, marginBottom: 24 }}>
          {/* Tag */}
          <div
            style={{
        ...
        {/* Floating Trusted Card in Upper Right above Photo */}
        <motion.div
        ...
        >
          ...
          {/* ── CARD 4: PROMINENT TEAM COLLABORATION PHOTO CARD ── */}
          <div style={{ gridColumn: 'span 3', position: 'relative' }}>
            <motion.div
            ...
            >
              ...
              {/* "Collaborative by nature" Overlay Pill on Photo */}
              <div
                style={{
                  position: 'absolute',
                  bottom: 14,
        ...
        {/* ─── 5. TOP-LEFT FLANK 3D ARTIFACTS: GLASS PLUS & PRISM (PROPERLY OFFSET OUTSIDE TEXT) ─── */}
        ...
        {/* Holographic Glass Prism near "ideas" on the left flank */}
        <motion.div
